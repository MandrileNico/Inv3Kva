...
// Refer to the datasheet for your particular device. 
   ...
   // GPIO (GENERAL PURPOSE I/O) CONFIG
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-03 (PIN74) - PIN FUNCTION = PWM2L
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-04 (PIN25) - PIN FUNCTION = PWM3H
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-05 (PIN75) - PIN FUNCTION = PWM3L
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-06 (PIN26) - PIN FUNCTION = PWMAux1
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-07 (PIN76) - PIN FUNCTION = PWMAux2
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-14 (PIN84) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-15 (PIN34) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //--------------------------------------------------------------------------------------
       //  GPIO-16 (PIN38) - PIN FUNCTION = GPIO16
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-17 (PIN88) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-18 (PIN39) - PIN FUNCTION = GPIO18
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-19 (PIN89) - PIN FUNCTION = DigIO1
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-20 (PIN40) - PIN FUNCTION = GPIO20
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-21 (PIN90) - PIN FUNCTION = DigIO2
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-22 (PIN41) - PIN FUNCTION = GPIO22 (CONTACTOR LINEA)
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-23 (PIN93) - PIN FUNCTION = DigIO3
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-24 (PIN35) - PIN FUNCTION = ENC-A
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-25 (PIN85) - PIN FUNCTION = ENC-B
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-26 (PIN36) - PIN FUNCTION = ENC-Z
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-27 (PIN86) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-28 (PIN43) - PIN FUNCTION = SCI-RX
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-29 (PIN93) - PIN FUNCTION = SCI-TX
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-30 (PIN44) - PIN FUNCTION = CANRX
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-31 (PIN94) - PIN FUNCTION = CANTX y LED2 (for Release 1.1 and up F2833x controlCARDs)
       ...
       //--------------------------------------------------------------------------------------
       //--------------------------------------------------------------------------------------
       //  GPIO-32 (PIN45) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-33 (PIN95) - PIN FUNCTION = --Spare--
       ...
       //  GPIO-48 (PIN30) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-49 (PIN80) - PIN FUNCTION = --Spare--
       ...
       //  GPIO-58 (PIN18) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-59 (PIN68) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-61 (PIN70) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-62 (PIN22) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-63 (PIN72) - PIN FUNCTION = --Spare--
       ...
       //  GPIO-84 (PIN31) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-85 (PIN81) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-86 (PIN32) - PIN FUNCTION = --Spare--
       ...
       //--------------------------------------------------------------------------------------
       //  GPIO-87 (PIN42) - PIN FUNCTION = GPIO87 (CONTACTOR CARGA)
